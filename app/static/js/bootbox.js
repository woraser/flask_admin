...
window.bootbox = window.bootbox || function a(b, c) {
        ...
        function h(a) {
            ...
            if (a.buttons && a.buttons.success) {
                a.buttons.success.label = (s[q.locale] ? s[q.locale]["OK"] : s.zh_CN["OK"]);
            }
            if (a.buttons && !a.buttons.cancel) {
                q.buttons.cancel.label = (s[q.locale] ? s[q.locale]["CANCEL"] : s.zh_CN["CANCEL"]);
                var tmpbuttons = a.buttons;
                a.buttons = {};
                a.buttons["cancel"] = q.buttons.cancel;
                for (var tmpkey in tmpbuttons)a.buttons[tmpkey] = tmpbuttons[tmpkey];
            }
            return a = b.extend({}, q, a), a.buttons || (a.buttons = {}), a.backdrop = a.backdrop ? "static" : !1, c = a.buttons, d = f(c), g(c, function (a, e, f) {
                ...
                e.label || (e.label = a), e.className || (e.className = 2 >= d && f === d - 1 ? "btn-primary-fo" : "btn-default-fo")
            }), a
        }
        ...
        r.alert = function () {
            var a;
            if (a = k(["ok"], arguments, ["message", "callback"]), a.title = "&nbsp;", a.callback && !b.isFunction(a.callback))throw new Error("alert requires callback property to be a function when provided");
            return a.buttons.ok.callback = a.onEscape = function () {
                return b.isFunction(a.callback) ? a.callback() : !0
            }, r.dialog(a)
        }, r.confirm = function () {
            var a;
            if (a = k(["cancel", "confirm"], arguments, ["message", "callback"]), a.title = "&nbsp;", a.buttons.cancel.callback = a.onEscape = function () {
                    return a.callback(!1)
            ...
            if (g(f, function (a, b) {
                ...
                }), d.find(".bootbox-body").html(a.message), a.animate === !0 && c.addClass("fade"), a.className && c.addClass(a.className), d.before(o.header), a.closeButton) {
                var k = b(o.closeButton);
                a.title ? c.find(".modal-header").append(k) : k.css("margin-top", "-10px").prependTo(d)
            }
            c.find('.modal-dialog').width(a.width);
            return a.title && c.find(".modal-title").html(a.title), i.length && (d.after(o.footer), c.find(".modal-header").append(i)), c.on("hidden.bs.modal", function (a) {
            ...
            }), c.on("click", ".modal-header button", function (a) {
        ...
        var s = {
            ...
            en_US: {OK: "OK", CANCEL: "Cancel", CONFIRM: "OK"},
            ...
            zh_TW: {OK: "确定", CANCEL: "取消", CONFIRM: "確認"}
        };
